...
public class StaticRateLimitPrincipalProvider implements RateLimitPrincipalProvider {
  ...
  public RateLimitPrincipal getPrincipal(String name) {
    return new RateLimitPrincipal(
      name,
      rateLimiterConfiguration.getRateSecondsByPrincipal().getOrDefault(name, rateLimiterConfiguration.getRateSeconds()),
      rateLimiterConfiguration.getCapacityByPrincipal().getOrDefault(name, rateLimiterConfiguration.getCapacity()),

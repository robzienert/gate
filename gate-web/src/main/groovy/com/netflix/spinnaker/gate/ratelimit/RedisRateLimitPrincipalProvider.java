...
public class RedisRateLimitPrincipalProvider implements RateLimitPrincipalProvider {
  ...
  private int getCapacity(Jedis jedis, String name) {
    ...
    return rateLimiterConfiguration.getCapacityByPrincipal().getOrDefault(name, rateLimiterConfiguration.getCapacity());
  }
  ...
  private int getRateSeconds(Jedis jedis, String name) {
    ...
    return rateLimiterConfiguration.getRateSecondsByPrincipal().getOrDefault(name, rateLimiterConfiguration.getRateSeconds());
  }
